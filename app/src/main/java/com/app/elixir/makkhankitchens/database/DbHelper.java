...
public class DbHelper extends SQLiteOpenHelper {
    ...
    String packagename = FoodOrdringApplication.getInstance().getPackageName();

    private static String PACKAGENAME = "com.app.elixir.makkhankitchens";
    private static String DB_PATH = "/data/data/" + PACKAGENAME + "/databases/";
    public static String DB_NAME = "fos.sqlite";
