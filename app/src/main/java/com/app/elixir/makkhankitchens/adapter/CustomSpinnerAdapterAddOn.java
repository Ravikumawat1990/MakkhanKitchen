...
public class CustomSpinnerAdapterAddOn extends BaseAdapter implements SpinnerAdapter {

    private final Context activity;
    private ArrayList<PojoItemDetail> asr;

    public CustomSpinnerAdapterAddOn(Context context, ArrayList<PojoItemDetail> asr) {
        this.asr = asr;
        activity = context;
    }
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        if (asr.get(position).getcAttributeValueLabel() != null) {
            txt.setText(asr.get(position).getcAttributeValueLabel() + " " + "(" + asr.get(position).getnPrice() + ")");
        } else {
            txt.setText("--");
        }
    ...
    public View getView(int i, View view, ViewGroup viewgroup) {
        ...
        if (asr.get(i).getcAttributeValueLabel() != null) {
            txt.setText(asr.get(i).getcAttributeValueLabel() + " " + "(" + asr.get(i).getnPrice() + ")");
        } else {
            txt.setText("--");
        }
