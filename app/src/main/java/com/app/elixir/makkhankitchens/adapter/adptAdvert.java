 ...
 */
public class adptAdvert extends RecyclerView.Adapter<adptAdvert.MyViewHolder> {
    ...
    public adptAdvert(Context context, ArrayList<CategoryModelArray> data) {
        this.dataSet = data;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapteradvt, parent, false);
