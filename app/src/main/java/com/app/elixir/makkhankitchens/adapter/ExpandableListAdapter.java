        ...
        viewHolderChild.radioButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (childText.getIsChecked().equals("0")) {
                    ...
                    ArrayList<PojoItemDetail> pojoItemDetails = ItemDetail.getAllCheckedRecord();
                    try {
                        Double aFloat;
                    ...
                    ArrayList<PojoItems> pojoItemses1 = Items.getAlldata();
                    ...
                    ViewFoodItemDetail.listAdapter.notifyDataSetChanged();
                    ViewFoodItemDetail.expListView.invalidateViews();
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_checkBox:
                ...
                ArrayList<PojoItems> pojoItemses = Items.getAlldata();
